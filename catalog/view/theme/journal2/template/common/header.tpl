...
<?php } ?>
<link rel="stylesheet" href="catalog/view/theme/journal2/css/animate.css">
<link rel="stylesheet" href="catalog/view/theme/journal2/css/custom-user.css">
<link rel="stylesheet" href="catalog/view/theme/journal2/css/hover.css">
<script type="text/javascript" src="catalog/view/theme/journal2/js/custom-user.js"></script>
...
<script>
    Journal.DIFF_DATE = Date.parse('<?php echo date('D M d Y H:i:s O'); ?>') - Date.parse(new Date);
    Journal.COUNTDOWN = {
