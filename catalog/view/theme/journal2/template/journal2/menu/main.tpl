        ...
        <div class="mega-menu">
            ...
            <div class="mega-menu-item <?php echo $menu_item['classes']; ?> <?php echo $menu_item['show_class']; ?>">
                <div>
                    ...
                    <a href="<?php echo $submenu_item['href']; ?>"><img class="lazy" src="<?php echo $submenu_item['dummy']; ?>" data-src="<?php echo $submenu_item['image']; ?>" data-default-src="<?php echo $submenu_item['image']; ?>" alt="<?php echo $submenu_item['name']; ?>"/></a>
                    <?php endif; ?>
        ...
        <div class="mega-menu">
            ...
            <div class="mega-menu-item <?php echo $menu_item['classes']; ?>">
                <div>
                    ...
                    <a href="<?php echo $submenu_item['href']; ?>"> <img class="lazy" src="<?php echo $submenu_item['dummy']; ?>" data-src="<?php echo $submenu_item['image']; ?>" alt="<?php echo $submenu_item['name']; ?>"/></a>
                    <?php endif; ?>
                    <ul>
