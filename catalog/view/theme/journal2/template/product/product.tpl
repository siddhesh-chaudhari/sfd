  ...
  <div class="product-info <?php echo $this->journal2->settings->get('split_ratio'); ?>" data-respond="start: 620px; end: 630px; interval: 10px;">
    ...
    <?php endforeach; ?>
      <div class="description">
        ...
        <?php else: ?>
        <?php if ($manufacturer) { ?>
        <span><?php echo $text_manufacturer; ?></span> <a href="<?php echo $manufacturers; ?>" itemprop="manufacturer"><?php echo $manufacturer; ?></a><br />
        <?php } ?>
        <?php endif; ?>
        ...
        <?php } ?>
        <span class="p-stock"><?php echo $text_stock; ?></span> <span class="journal-stock <?php echo isset($stock_status) ? $stock_status : ''; ?>"><?php echo $stock; ?></span></div>
      <?php if (isset($date_end) && $date_end && $this->journal2->settings->get('show_countdown_product_page', 'on') == 'on'): ?>
      <div><div class="countdown"></div></div>
      ...
      <div class="options push-<?php echo $this->journal2->settings->get('product_page_options_push_select'); ?>" >
		...
		<?php echo "<script>hideOptions();</script>";?>
      ...
      <?php } ?>
      <div class="cart">
        <div><span class="qty" style="display:none;"><span class="text-qty"><?php echo $text_qty; ?></span>
