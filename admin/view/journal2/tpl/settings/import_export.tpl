        ...
        <accordion-group is-open="true">
            ...
            <ul class="module-create-options">
                ...
                <li>
                    ...
                    <span class="module-create-option">
                        <a class="btn blue" data-ng-click="confirmation($event)" data-ng-href="<?php echo $export_href;?>&include_store_data={{settings.include_store_data}}&add_dummy_images={{settings.add_dummy_images}}">Export</a>
                    </span>
                    <a href="#" target="_blank" class="journal-tip"></a>
                </li>
            </ul>
