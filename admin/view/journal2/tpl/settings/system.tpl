...
<div class="module-body">
    ...
    <accordion close-others="false">
        ...
        <accordion-group is-open="true" data-ng-show="settings.developer_mode == 0">
            <accordion-heading>
                <div class="accordion-bar bar-level-0">Images</div>
            </accordion-heading>
            <ul class="module-create-options">
                <li>
                    ...
                    <span class="module-create-option">
                        <span class="progress">
                            <span class="progress-text">{{cachingStatus.optimised}} of {{cachingStatus.total}} image(s) optimised ({{cachingStatus.percent}}%)</span>
                ...
                <li>
                    ...
                    <span class="module-create-option">
                        <a class="btn blue" data-ng-class="{ disabled: imageOptimisationInProgress }" data-ng-click="startImageOptimisation()">Optimise</a>
                        <a class="btn blue" data-ng-class="{ disabled: imageOptimisationInProgress }" data-ng-click="startImageOptimisation(true)">Optimise All</a>
                        <a class="btn red" data-ng-class="{ disabled: !imageOptimisationInProgress }" data-ng-click="stopImageOptimisation()">Stop</a>
                    </span>
                    <a href="#" target="_blank" class="journal-tip"></a>
                </li>
            </ul>
