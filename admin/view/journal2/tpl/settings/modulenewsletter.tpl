...
<div class="module-body custom-code">
    ...
    <accordion id="main-accordion" close-others="accordion.close_others">
        ...
        <accordion-group is-open="true">
            <accordion-heading>
                <div class="accordion-bar bar-level-0">Newsletter Subscribers <a href="javascript:;" class="accordion-remove slide-remove news-export" data-ng-click="exportCSV($event)"><b></b>Export CSV</a></div>
            </accordion-heading>
