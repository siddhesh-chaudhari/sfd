...
<div class="menu-title">Menu</div>
	...
	<div class="container">
		<div class="title"><div style="padding-top:15px;">CSV IMPORT<a href="csv.php?logout=1"><div class="back-to-home">X</div></a></div></div>
		<div class="content">
			
			<form name="csvUpload" id="csvUpload" enctype="multipart/form-data" action="upload.php" method="POST">
			<div class="form-title">CSV File : </div>
			
			<div class="form-file-select">
			<input type="file" name="file" id="file" > 
			<button type="submit" name="submit" class="submit-button">Import</button>
			</div>
	...
	<?php if (isset($_GET['error'])){
			...
			if(isset($_GET['products'])){
				echo "<script>alert('".$_GET['products']." Products added in Database. ".$_GET['updated']." Products updated.'); window.location='index.php';</script>";
			}
